...
class Social_media(TranslatableModel):
    Platform=[(mark_safe(f"<img src='' alt='fb'>")+'Facebook','Facebook'),(mark_safe(f"<img src='' alt='insta'>")+'Insta','Insta'),(mark_safe(f"<img src='' alt='whats'>")+'Whatsapp','Whatsapp'),]
    ...
    postgraph = models.ImageField(verbose_name=_("postgraph"),upload_to="postgraphs in %d %M %Y",default="soc.jpg"),
...
class Printing(TranslatableModel):
    Type=[(mark_safe(f"<img src='' alt='laser'>")+'Laser','Laser'),(mark_safe(f"<img src='' alt='Paper'>")+'Paper','Paper'),(mark_safe(f"<img src='' alt='Baner'>")+'Baner','Baner'),(mark_safe(f"<img src='' alt='Stuff'>")+' Stuff','Stuff'),]
    for_client=models.ForeignKey(User_profile,related_name=_("for_client_x1"),on_delete=models.SET_NULL,null=True),
    
    trans_x=TranslatedFields(campagin_cost = models.CharField(verbose_name=_("campagin_cost"),max_length = 30,choices=Type,default=Type[0]),
     ...
     bio = models.TextField(verbose_name=_("bio"), max_length=400,default=default_info),
     price_per_item=models.FloatField(verbose_name=_("price_per_item"),default=1.50,max_length=3000.00),
